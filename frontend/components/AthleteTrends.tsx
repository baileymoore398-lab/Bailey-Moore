  ...
  return (
    <ResponsiveContainer width="100%" height={240}>
      <LineChart data={trend} margin={{ top: 8, right: 12, left: -16, bottom: 0 }}>
        ...
        <XAxis dataKey="race" tick={{ fill: "#9aa089", fontSize: 10 }} interval={0} angle={-12} textAnchor="end" height={48} />
        <YAxis domain={[40, 100]} tick={{ fill: "#9aa089", fontSize: 11 }} />
        <Tooltip contentStyle={tooltipStyle} />
        <Line type="monotone" dataKey="overall" stroke="#2ecf6e" strokeWidth={2.5} dot={{ r: 3 }} name="Overall" />
